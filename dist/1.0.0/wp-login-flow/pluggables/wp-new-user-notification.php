...
if ( ! function_exists( 'wp_new_user_notification' ) ) :
	...
	function wp_new_user_notification( $user_id, $plaintext_pass = '' ) {
		...
		$default_subject = sprintf( __( '[%s] Account Activation', 'wp-login-flow' ), get_option( 'blogname' ) );
		$default_message  = sprintf( __( "Welcome to %s! Please visit the link below to activate your account and set your password:", 'wp-login-flow' ), get_option( 'blogname' ) ) . "\r\n\r\n";
